            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="section-title m-0">Edit Product</h2>
                    ...
                    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <small class="form-text text-muted">Format contoh: 150.000 (tanpa Rp dan tanpa
                                    desimal)</small>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">Masukkan deskripsi produk dan spesifikasi di
                                    sini.</small>
                                ...
                                <div class="card mt-3">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <select id="template-selector" class="form-control form-control-sm"
                                                style="width: auto;">
                                        ...
                                        <div id="harmonika-template">
                                            <button type="button" class="btn btn-sm btn-primary mb-2"
                                                id="insert-template">Masukkan Template</button>
                                            <div class="template-preview p-2 bg-light"
                                                style="font-size: 0.85rem; max-height: 300px; overflow-y: auto;">

                                                <div class="form-group">
                                                    <label><strong>Jenis Harmonika:</strong></label>
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="jenis[]" value="Diatonik">
                                                            Diatonik</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="jenis[]" value="Kromatik">
                                                            Kromatik</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="jenis[]" value="Tremolo">
                                                            Tremolo</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Jenis lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="lubang[]" value="10"> 10
                                                        </div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="lubang[]" value="12"> 12
                                                        </div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="lubang[]" value="16"> 16
                                                        </div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="lubang[]" value="24">
                                                            24</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Jumlah lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="nada[]" value="C Mayor">
                                                            C Mayor</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="nada[]" value="G Mayor">
                                                            G Mayor</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="nada[]" value="A Minor">
                                                            A Minor</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Nada lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="material[]"
                                                                value="Plastik ABS"> Plastik ABS</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="material[]"
                                                                value="Kayu"> Kayu</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="material[]"
                                                                value="Logam"> Logam</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Material lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="reed[]" value="Kuningan">
                                                            Kuningan</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="reed[]"
                                                                value="Fosfor Perunggu"> Fosfor Perunggu</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="reed[]"
                                                                value="Stainless Steel"> Stainless Steel</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Bahan lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="cover[]"
                                                                value="Stainless steel"> Stainless steel</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="cover[]"
                                                                value="Chrome-plated"> Chrome-plated</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="cover[]"
                                                                value="Aluminium"> Aluminium</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Material lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div>Panjang ± <input type="text"
                                                                class="form-control form-control-sm d-inline"
                                                                style="width: 80px" value="10-12"> cm,</div>
                                                        <div class="ml-2">Lebar ± <input type="text"
                                                                class="form-control form-control-sm d-inline"
                                                                style="width: 80px" value="2.5-3.5"> cm,</div>
                                                        <div class="ml-2">Tinggi ± <input type="text"
                                                                class="form-control form-control-sm d-inline"
                                                                style="width: 80px" value="2-3"> cm</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div>± <input type="text"
                                                                class="form-control form-control-sm d-inline"
                                                                style="width: 80px" value="80-150"> gram</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="sistem[]" value="Richter">
                                                            Richter</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="sistem[]"
                                                                value="Solo Tuning"> Solo Tuning</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="sistem[]"
                                                                value="Asian Tuning"> Asian Tuning</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Sistem lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="fitur[]"
                                                                value="Anti-slip grip"> Anti-slip grip</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="fitur[]"
                                                                value="Lubang ventilasi"> Lubang ventilasi</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Fitur lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="kelengkapan[]"
                                                                value="Hardcase"> Hardcase</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="kelengkapan[]"
                                                                value="Soft pouch"> Soft pouch</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="kelengkapan[]"
                                                                value="Kain pembersih"> Kain pembersih</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="kelengkapan[]"
                                                                value="Buku panduan"> Buku panduan</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Kelengkapan lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="rekomendasi[]"
                                                                value="Pemula"> Pemula</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="rekomendasi[]"
                                                                value="Menengah"> Menengah</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="rekomendasi[]"
                                                                value="Profesional"> Profesional</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Rekomendasi lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="warna[]" value="Hitam">
                                                            Hitam</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="warna[]" value="Silver">
                                                            Silver</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="warna[]" value="Emas">
                                                            Emas</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="warna[]" value="Merah">
                                                            Merah</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="warna[]" value="Biru">
                                                            Biru</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Warna lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="brand[]" value="Suzuki">
                                                            Suzuki</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="brand[]" value="Hohner">
                                                            Hohner</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="brand[]" value="Easttop">
                                                            Easttop</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Brand lainnya">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="traditional-template" style="display: none;">
                                            <button type="button" class="btn btn-sm btn-primary mb-2"
                                                id="insert-template-traditional">Masukkan Template</button>
                                            <div class="template-preview p-2 bg-light"
                                                style="font-size: 0.85rem; max-height: 300px; overflow-y: auto;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="jenis_trad[]"
                                                                value="Karinding"> Karinding</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="jenis_trad[]"
                                                                value="Genggong"> Genggong</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="jenis_trad[]"
                                                                value="Jaw harp"> Jaw harp</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Jenis lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="bahan_trad[]"
                                                                value="Bambu tua"> Bambu tua</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="bahan_trad[]"
                                                                value="Besi"> Besi</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="bahan_trad[]"
                                                                value="Kuningan"> Kuningan</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="bahan_trad[]"
                                                                value="Kayu keras"> Kayu keras</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Bahan lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="asal_trad[]"
                                                                value="Jawa Barat"> Jawa Barat</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="asal_trad[]"
                                                                value="Bali"> Bali</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="asal_trad[]"
                                                                value="Kalimantan"> Kalimantan</div>
                                                        <div class="form-check mr-3"><input type="checkbox"
                                                                class="form-check-input" name="asal_trad[]"
                                                                value="Papua"> Papua</div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Daerah lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div>Panjang ± <input type="text"
                                                                class="form-control form-control-sm d-inline"
                                                                style="width: 80px" value="10-15"> cm,</div>
                                                        <div class="ml-2">Lebar ± <input type="text"
                                                                class="form-control form-control-sm d-inline"
                                                                style="width: 80px" value="2-3"> cm,</div>
                                                        <div class="ml-2">Ketebalan ± <input type="text"
                                                                class="form-control form-control-sm d-inline"
                                                                style="width: 80px" value="0.5-1"> cm</div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="teknik_trad[]" value="Ditempelkan ke bibir/mulut">
                                                            Ditempelkan ke bibir/mulut
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="teknik_trad[]" value="Dipetik dengan jari">
                                                            Dipetik dengan jari
                                                        </div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Teknik lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="suara_trad[]" value="Getaran alami">
                                                            Getaran alami
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="suara_trad[]" value="Nada rendah">
                                                            Nada rendah
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="suara_trad[]" value="Nada tinggi">
                                                            Nada tinggi
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="suara_trad[]" value="Resonansi unik">
                                                            Resonansi unik
                                                        </div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Ciri lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="manfaat_trad[]" value="Media relaksasi">
                                                            Media relaksasi
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="manfaat_trad[]" value="Kesenian daerah">
                                                            Kesenian daerah
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="manfaat_trad[]" value="Upacara adat">
                                                            Upacara adat
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="manfaat_trad[]" value="Pendidikan budaya">
                                                            Pendidikan budaya
                                                        </div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Manfaat lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="rekomendasi_trad[]" value="Kolektor alat musik">
                                                            Kolektor alat musik
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="rekomendasi_trad[]"
                                                                value="Pengajar seni dan budaya">
                                                            Pengajar seni dan budaya
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="rekomendasi_trad[]" value="Pecinta musik etnik">
                                                            Pecinta musik etnik
                                                        </div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Rekomendasi lainnya">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="warna_trad[]" value="Warna alami bambu">
                                                            Warna alami bambu
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="warna_trad[]" value="Warna alami logam">
                                                            Warna alami logam
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="warna_trad[]" value="Ukiran motif khas">
                                                            Ukiran motif khas
                                                        </div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Tampilan lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="perawatan_trad[]" value="Simpan di tempat kering">
                                                            Simpan di tempat kering
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="perawatan_trad[]"
                                                                value="Bersihkan dengan kain kering">
                                                            Bersihkan dengan kain kering
                                                        </div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Perawatan lainnya">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center">
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="kemasan_trad[]" value="Kemasan anyaman">
                                                            Kemasan anyaman
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="kemasan_trad[]" value="Kain tradisional">
                                                            Kain tradisional
                                                        </div>
                                                        <div class="form-check mr-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                name="kemasan_trad[]" value="Kotak kayu">
                                                            Kotak kayu
                                                        </div>
                                                        <input type="text" class="form-control form-control-sm"
                                                            style="width: 150px" placeholder="Kemasan lainnya">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="number"
                                                ...
                                                min="0" {{ $product->track_inventory ? '' : 'disabled' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="custom-control custom-switch mt-4">
                                            <input type="checkbox" class="custom-control-input" name="track_inventory"
                                                id="track_inventory" value="1"
                                                {{ old('track_inventory', $product->track_inventory) ? 'checked' : '' }}>
                                            <label class="custom-control-label" for="track_inventory">Track
                                                Inventory</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">New Image (optional)</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="featured">Show in featured section on
                                        homepage</label>
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $("#insert-template").click(function() {
                ...
                if (templateType === 'harmonika') {
                    ...
                    let jenisCustom = $("input[name='jenis[]']").closest(".d-flex").find(
                        "input[type='text']").val();
                    ...
                    let lubangCustom = $("input[name='lubang[]']").closest(".d-flex").find(
                        "input[type='text']").val();
                    ...
                    let nadaCustom = $("input[name='nada[]']").closest(".d-flex").find("input[type='text']")
                        .val();
                    ...
                    let materialCustom = $("input[name='material[]']").closest(".d-flex").find(
                        "input[type='text']").val();
                    ...
                    let reedCustom = $("input[name='reed[]']").closest(".d-flex").find("input[type='text']")
                        .val();
                    ...
                    let coverCustom = $("input[name='cover[]']").closest(".d-flex").find(
                        "input[type='text']").val();
                    if (coverCustom) coverValues.push(coverCustom);

                    // Get ukuran values
                    let panjang = $("label:contains('Ukuran:')").closest(".form-group").find("input").eq(0)
                        .val();
                    let lebar = $("label:contains('Ukuran:')").closest(".form-group").find("input").eq(1)
                        .val();
                    let tinggi = $("label:contains('Ukuran:')").closest(".form-group").find("input").eq(2)
                        .val();
                    ...
                    let sistemCustom = $("input[name='sistem[]']").closest(".d-flex").find(
                        "input[type='text']").val();
                    ...
                    let fiturCustom = $("input[name='fitur[]']").closest(".d-flex").find(
                        "input[type='text']").val();
                    ...
                    let kelengkapanCustom = $("input[name='kelengkapan[]']").closest(".d-flex").find(
                        "input[type='text']").val();
                    ...
                    let rekomendasiCustom = $("input[name='rekomendasi[]']").closest(".d-flex").find(
                        "input[type='text']").val();
                    ...
                    let warnaCustom = $("input[name='warna[]']").closest(".d-flex").find(
                        "input[type='text']").val();
                    ...
                    let brandCustom = $("input[name='brand[]']").closest(".d-flex").find(
                        "input[type='text']").val();
...
Brand/Merek: ${brandValues.length > 0 ? brandValues.join(', ') : '[Pilih brand]'}`;
            ...
            $("#insert-template-traditional").click(function() {
                ...
                let jenisCustom = $("input[name='jenis_trad[]']").closest(".d-flex").find(
                    "input[type='text']").val();
                if (jenisCustom) jenisValues.push(jenisCustom);
                ...
                let bahanCustom = $("input[name='bahan_trad[]']").closest(".d-flex").find(
                    "input[type='text']").val();
                ...
                let asalCustom = $("input[name='asal_trad[]']").closest(".d-flex").find(
                    "input[type='text']").val();
                if (asalCustom) asalValues.push(asalCustom);

                // Get ukuran values
                let panjang = $("#traditional-template label:contains('Ukuran:')").closest(".form-group")
                    .find("input").eq(0).val();
                let lebar = $("#traditional-template label:contains('Ukuran:')").closest(".form-group")
                    .find("input").eq(1).val();
                let ketebalan = $("#traditional-template label:contains('Ukuran:')").closest(".form-group")
                    .find("input").eq(2).val();
                ...
                let teknikCustom = $("input[name='teknik_trad[]']").closest(".d-flex").find(
                    "input[type='text']").val();
                ...
                let suaraCustom = $("input[name='suara_trad[]']").closest(".d-flex").find(
                    "input[type='text']").val();
                ...
                let manfaatCustom = $("input[name='manfaat_trad[]']").closest(".d-flex").find(
                    "input[type='text']").val();
                ...
                let rekomendasiCustom = $("input[name='rekomendasi_trad[]']").closest(".d-flex").find(
                    "input[type='text']").val();
                if (rekomendasiCustom) rekomendasiValues.push(rekomendasiCustom);
                ...
                let warnaCustom = $("input[name='warna_trad[]']").closest(".d-flex").find(
                    "input[type='text']").val();
                if (warnaCustom) warnaValues.push(warnaCustom);
                ...
                let perawatanCustom = $("input[name='perawatan_trad[]']").closest(".d-flex").find(
                    "input[type='text']").val();
                ...
                let kemasanCustom = $("input[name='kemasan_trad[]']").closest(".d-flex").find(
                    "input[type='text']").val();
