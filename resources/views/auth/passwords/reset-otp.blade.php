                    ...
                    <div class="col-md-6" style="background-color: #f9f7ed;">
                        <div class="card-body p-5">
                            <div class="text-center mb-4">
                                <h2 class="fw-bold" style="color: #c9a253;">{{ __('Verify OTP Code') }}</h2>
                            ...
                            <div class="alert border-start border-4 border-info bg-info bg-opacity-10" style="border-radius: 10px; border-color: #c9a253 !important;">
                            ...
                            <form method="POST" action="{{ route('password.verify-otp') }}">
                                ...
                                <div class="mb-4">
                                    <label for="otp" class="form-label" style="color: #91784a;">{{ __('Verification Code') }}</label>
                                    <input id="otp" type="text"
                                        ...
                                        style="border-radius: 10px; border: 1px solid #dfd6b3; background-color: #fefdf9; letter-spacing: 0.5em; text-align: center;">
                                ...
                                <div class="text-center">
                                    <a class="text-decoration-none"
                                        href="{{ route('password.resend-otp') }}"
